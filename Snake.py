...
def game(genome, config):
    ...
    while not gameOver:
        ...
        # Display the generation number on the screen
        generation_text = font.render(f'Generation: {GENERATION} Best Score: {BESTSCORE} Genome: {genome.key}', True, (0, 0, 0))
        display.blit(generation_text, (10, 10))
